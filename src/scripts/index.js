...
const inputAboutProfile = popupProfile.querySelector('.popup__input_type_description');  // ввод 'о себе' в попап профиля.
...
const formAddFoto = popupAddFoto.querySelector('.popup__form');      // форма ввода добавление картинок.
